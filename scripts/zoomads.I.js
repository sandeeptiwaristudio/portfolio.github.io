  ...
  (function () {
    (function () {
      ...
      var Ja = "appendChild",
        ...
        ni = "highlight",
        oi = "horizontal",
        pi = "http://web.archive.org/web/20190115191618/http://csi.gstatic.com/csi",
        qi = "http://www.google.com",
        ri = "https:",
        si = "http://web.archive.org/web/20190115191618/https://csi.gstatic.com/csi",
        ti = "i",
        ui = "i18n_input",
        vi = "id",
        wi = "iframe",
      ...
      function Qo(a) {
        ...
        f = f[Tb];
        Y ? (b.left += d, b.top += f) : (na(b, r.max(b[y], d)), b.top = r.max(b.top, f));
      ...
      function Ro(a) {
        ...
        if (a[Ka]) b = Oo(a), a = Ao(Pn(c)), g.x = b[y] + a.x, g.y = b.top + a.y;
          ...
          for (b = a;
            (b = Po(b)) && b != c[mc] && b != h;)
            if (g.x -= b[vc], !To || b[Cc] != Wf) g.y -= b[Tb]
        }
        return g
      }
      ...
      function vp(a, b, c, d, f, g, h) {
        ...
        if (g) {
          if (f) {
            ...
            if (d.y < f.top && g & 4) d.y = f.top, k |= 2;
      ...
      function gy(a) {
        ...
        if (hy[Ma](c)) return b.sf = iy(c), wa(b, ji), b;
          ...
          a = Number(a),
          c = Number(c),
          (ha(f) || f < 0 || f > 255 || ha(a) || a < 0 || a > 255 || ha(c) || c < 0 || c > 255) && e(m('"(' + f + vd + a + vd + c + '") is not a valid RGB color')),
          f = ky(f[Wb](16)),
          a = ky(a[Wb](16)),
          c = ky(c[Wb](16)),
          b.sf = Vc + f + a + c,
          wa(b, wk),
          b;
          else if (ly && (c = ly[a[Lc]()])) return b.sf = c,
          wa(b, Nj),
          b
        }
      ...
      function Xy(a) {
        ...
        qn(Bq(this.c, this.d.b), new wu(c.N, c.X, c.B));
        try {
          Cq(this.c, this.d)
        } catch (k) {}
        this.b = new wq;
        ...
        if (Hz) {
          ...
          try {
            if (k) {
              ...
              h = f[!0];
              h.mb = h.G;
              for (var La = z[E] - 1; !q.Yc && La >= 0 && h.mb; La--) ma(q, z[La]), g &= mq(h, z[La], d, !0, q);
              if (o) {
                h = f[!1];
                h.mb = h.G;
      ...
      Q.Wb = function () {
        ...
        if (a.$b()) {
          ...
          b = new qs(this, a);
          c.ef(a) || this.Ch(b)
        } else b = this.Z(), c = new fs(b, a.A(), a.D()), b = new fs(b, a.I(), a.aa()), b = new qs(this, c, b, a);
        return b
      };
      Q.Cd = function () {
        var a = ts(this);
      ...
      Q.bd = function (a) {
        ...
        switch (a[A]) {
          ...
          case 40:
            ...
            break;
          case 39:
            if (this.vd == oi) fu(this) ? this.kc() : this.jc();
            else return !1;
            break;
          default:
            return !1
          ...
          if (a.F && b[A] == 13) b[C] == oj && (f = new Rt(13, 0, !1, b));
            ...
            switch (b[C]) {
              case oj:
                ...
                LA && !Hq(b[A], f.lastKey, b[Bc], b[hc], b[Xb]) ? f = Tt(b, f) : (sa(f, Z && b[A] in KA ? KA[b[A]] : b[A]), f = j);
                break a;
              case qj:
                f.lastKey = -1;
                sa(f, -1);
      ...
      Q.Bh = function (a, b, c) {
        ...
        var f = this,
          ...
          c = c[1];
        if (!b || !c)
          if (g.c) c = Zw(this, g) || g, qa(c, Kh), k(c, !1, !1, j);
          else
        ...
        if (zu(this.zd, c, n[ub](b[A] || b[vb]))) {
          ...
          if (d = !!c) a: {
            if (c.xc()) {
              ...
              c.xc() && !c.Sa() && (f = this.ea(a), Gp(c), d = c.q(), f = new Bw(d, f), this.c[d] || (this.c[d] = []), this.c[d][s](c), this.j.Ad(f, this.f) === !1 && c.Kf())
            }
      ...
      Q.bd = function (a) {
        ...
        if (b = mx(this)) a: if (this.d.Le(this, a)) {
          ...
          b = mu(this.d, this, a) ? this.d.yf(this, a, n[ub](a[vb])) : !1
      ...
      Q.lc = function (a) {
        ...
        switch (a[A]) {
          ...
          case 38:
            ...
            break;
          case 40:
            if (d == -1 && (d = -c), d < b - c) return By(this, d + c), a[bb](), !0
        }
        return !1
      };
      Q.xj = bm();
      ...
      Q.ij = function (a, b) {
        ...
        this.b[Bb](rj, T(this.ah, this, d, c))
      };
      Q.ah = function (a, b) {
      ...
      if (l[jb]) {
        ...
        var iB = function (a, b, c) {
          ...
          jB = function (a, b, c) {
            ...
            var g = l.chrome;
            if (g && (g = g.loadTimes)) g().wasFetchedViaSpdy && (d += jd), g().wasNpnNegotiated && (d += id), g().wasAlternateProtocolAvailable && (d += dd);
            a.Rj && (d += ad + a.Rj);
            var h = a.t,
              k = h[sc],
              g = [],
